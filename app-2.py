...
def inject_css():
    ...
    <style>
      ...
      .stApp                       { background: #07111f !important; color: #e2e8f0; }
      ...
      [data-testid="stTextArea"] textarea:focus {
        ...
        box-shadow: 0 0 0 3px rgba(26,159,212,0.15) !important;
      }
      [data-testid="stTextInput"] input::placeholder,
      [data-testid="stTextArea"] textarea::placeholder { color: #4d6a8a !important; }
      ...
      /* ── Number input dark ── */
      [data-testid="stNumberInput"] { color: #e2e8f0 !important; }

      /* ── Sliders dark ── */
      [data-testid="stSlider"] > div { color: #e2e8f0 !important; }
      [data-testid="stSlider"] [data-baseweb="slider"] div { background: #1a3060 !important; }
      ...
      [data-testid="stExpander"] summary { color: #93b4d4 !important; }
      ...
      .stSuccess { background: rgba(22,163,74,0.12) !important; border: 1px solid rgba(22,163,74,0.30) !important; color: #86efac !important; }
      .stWarning { background: rgba(217,119,6,0.12)  !important; border: 1px solid rgba(217,119,6,0.30)  !important; color: #fcd34d !important; }
      .stError   { background: rgba(220,38,38,0.12)  !important; border: 1px solid rgba(220,38,38,0.30)  !important; color: #fca5a5 !important; }
      .stInfo    { background: rgba(26,159,212,0.10)  !important; border: 1px solid rgba(26,159,212,0.25) !important; color: #7dd3fc !important; }

      /* ── Sidebar ── */
      [data-testid="stSidebar"] { background: #07111f !important; border-right: 1px solid #0d1f3c; }
      ...
      [data-testid="stSidebar"] .stButton > button {
        ...
        color: #6b8fae !important; padding: 9px 16px; border-radius: 6px;
      ...
      div[data-testid="metric-container"] {
        ...
        border-top: 3px solid #1a9fd4 !important;
        box-shadow: 0 2px 12px rgba(0,0,0,0.3) !important;
        transition: all 0.2s !important;
      }
      div[data-testid="metric-container"]:hover { transform: translateY(-2px) !important; box-shadow: 0 8px 24px rgba(0,0,0,0.4) !important; }
      div[data-testid="metric-container"] label { color: #6b8fae !important; font-size: 11px !important; font-weight: 700 !important; text-transform: uppercase !important; letter-spacing: 0.8px !important; }
      div[data-testid="metric-container"] div[data-testid="stMetricValue"] { color: #e8f0fa !important; font-size: 28px !important; font-weight: 800 !important; font-family: 'JetBrains Mono', monospace !important; }
      div[data-testid="metric-container"] div[data-testid="stMetricDelta"] { font-size: 11px !important; font-weight: 600 !important; }
      ...
      .panel-title {
        ...
        color: #6b8fae !important; margin-bottom: 16px !important;
        text-transform: uppercase !important; letter-spacing: 1px !important;
        border-bottom: 1px solid #1a3060 !important; padding-bottom: 12px !important;
      }

      /* ── Pro forma table dark ── */
      .proforma-table { width:100%; border-collapse:collapse; font-size:13px; }
      .proforma-table th { text-align:right; padding:10px 12px; background:#0a1628; color:#6b8fae; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.5px; border-bottom:1px solid #1a3060; }
      .proforma-table th:first-child { text-align:left; }
      .proforma-table td { text-align:right; padding:9px 12px; border-bottom:1px solid #0d1f3c; color:#cbd5e1; font-family:'JetBrains Mono',monospace; font-size:12px; }
      .proforma-table td:first-child { text-align:left; font-family:'Inter',sans-serif; font-weight:500; color:#93b4d4; }
      .proforma-table tr.noi-row td { font-weight:800; background:rgba(26,159,212,0.12); color:#1a9fd4; border-top:1px solid rgba(26,159,212,0.3); border-bottom:1px solid rgba(26,159,212,0.3); }
      .proforma-table tr.subtotal td { background:#0a1628; font-weight:700; }
      .proforma-table tr:hover { background:rgba(255,255,255,0.02); }

      /* ── Grade badges dark ── */
      .grade-badge { display:inline-block; padding:4px 16px; border-radius:20px; font-weight:800; font-size:22px; letter-spacing:-0.5px; }
      .grade-a { background:rgba(22,163,74,0.15);  color:#4ade80; }
      .grade-b { background:rgba(26,159,212,0.15); color:#38bdf8; }
      .grade-c { background:rgba(234,179,8,0.15);  color:#facc15; }
      .grade-d { background:rgba(220,38,38,0.15);  color:#f87171; }

      /* ── Tracker cards dark ── */
      .tracker-card  { background:#0d1f3c; border:1px solid #1a3060; border-radius:8px; padding:14px 16px; margin-bottom:10px; border-left:4px solid #1a9fd4; }
      .tracker-correct { border-left-color:#4ade80; }
      .tracker-watch   { border-left-color:#facc15; }
      .tracker-alert   { border-left-color:#f87171; }

      /* ── Status pills dark ── */
      .status-pill   { padding:3px 10px; border-radius:12px; font-size:11px; font-weight:700; }
      .status-active { background:rgba(26,159,212,0.15); color:#38bdf8; }
      .status-closed { background:rgba(22,163,74,0.15);  color:#4ade80; }
      ...
      /* ── Onboarding tooltip ── */
      .onboard-tip {
        background: linear-gradient(135deg, #0d2a4a, #0d1f3c);
        border: 1px solid #1a9fd4;
        border-left: 4px solid #1a9fd4;
        border-radius: 10px;
        padding: 16px 20px;
        margin-bottom: 20px;
        box-shadow: 0 4px 20px rgba(26,159,212,0.15);
        position: relative;
      }
      .onboard-step {
        font-size: 10px; font-weight: 700; color: #1a9fd4;
        text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;
      }
      .onboard-title {
        font-size: 14px; font-weight: 800; color: #e8f0fa; margin-bottom: 6px;
      }
      .onboard-text {
        font-size: 13px; color: #93b4d4; line-height: 1.7;
      }
      .onboard-badge {
        display: inline-block; background: rgba(26,159,212,0.15);
        color: #1a9fd4; font-size: 10px; font-weight: 700;
...
def render_sidebar():
    with st.sidebar:
        st.markdown(f'''
        <div style="padding:20px 12px 20px;border-bottom:1px solid rgba(255,255,255,0.07);
                    margin-bottom:8px;text-align:center;">
          <div style="background:#ffffff;border-radius:12px;display:inline-block;
                      padding:10px 16px;margin-bottom:10px;
                      box-shadow:0 3px 14px rgba(0,0,0,0.30);">
            <img src="{AIRE_LOGO_URI}" style="height:52px;display:block;" />
          </div>
